# Generated by Powerlevel10k configuration wizard on 2026-04-02 at 14:34 +07.
...
() {
  ...
  # Minimal prompt: only current path and git status.
  ...
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND='#c4a7e7'
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND='#9ccfd8'
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND='#ebbcba'
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR='#eb6f92'
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND='#31748f'
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND='#f6c177'
  typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND='#ebbcba'
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND='#7aa2f7'
